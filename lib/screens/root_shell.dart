...
/// Вкладки переключаются через PageView — можно свайпать пальцем между
/// экранами, а не только тапать по нижним иконкам.
        ...
        return Scaffold(
          ...
          bottomNavigationBar: BottomAppBar(
            ...
            child: Row(
              ...
              children: [
                _NavItem(icon: Icons.home_outlined, activeIcon: Icons.home, label: 'Обзор', selected: index == 0, onTap: () => goTo(0)),
                _NavItem(icon: Icons.receipt_long_outlined, activeIcon: Icons.receipt_long, label: 'Операции', selected: index == 1, onTap: () => goTo(1)),
                const SizedBox(width: 48),
                _NavItem(icon: Icons.pie_chart_outline, activeIcon: Icons.pie_chart, label: 'Аналитика', selected: index == 2, onTap: () => goTo(2)),
                _NavItem(icon: Icons.settings_outlined, activeIcon: Icons.settings, label: 'Настройки', selected: index == 3, onTap: () => goTo(3)),
              ],
            ),
          ),
        );
